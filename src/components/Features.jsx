            ...
            >
              <Paper>
                <ClickAwayListener onClickAway={handleClose}>
                  ...
                  >
                    <MenuItem style={{color:'hsl(0, 0%, 41%)'}} onClick={handleClose}><div style={{marginRight:'12px'}} src="../images/icon-todo.svg">
                    ...
                    <MenuItem style={{color:'hsl(0, 0%, 41%)'}} onClick={handleClose}><div style={{marginRight:'12px'}} src="../images/icon-calendar.svg">
                    ...
                    <MenuItem style={{color:'hsl(0, 0%, 41%)'}} onClick={handleClose}><div style={{marginRight:'12px'}} src="../images/icon-reminders.svg">
                    ...
                    <MenuItem style={{color:'hsl(0, 0%, 41%)'}} onClick={handleClose}><div style={{marginRight:'12px'}} src="../images/icon-planning.svg">
